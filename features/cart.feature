...
Scenario: Add a 10 dollar item to cart with a 5 dollar item
  Given I have a cart with a "5" dollar item named "tee"
  When I add a "10" dollar item named "shirt"
  Then My subtotal should be "15" dollars

Scenario: Apply a 10 percent coupon code to cart with 10 dollars of items
...
Scenario: Add a 2nd item to cart after applying a discount
  Given I have an empty cart
...
Scenario: Add a 2nd item to cart and discount after applying a discount
  Given I have an empty cart
  When I add a "20" dollar item named "tank"
  And I apply a "10" percent coupon code
  Then My subtotal should be "18" dollars
  And I add a "80" dollar item named "dress"
  And I apply a "20" percent coupon code
  Then My subtotal should be "72" dollars
